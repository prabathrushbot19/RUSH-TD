...
console.log("Connecting RUSH-TD 🧬...");
...
if (mek.key && mek.key.remoteJid === 'status@broadcast'&& config.js.AUTO_READ_STATUS === "true"){
...
if(!isowner && isGroup  && congig.MODE === "inbox")return
if(!isowner && !isgroup && congig.MODE === "groups")return
//=============================================================
